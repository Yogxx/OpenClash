...
function index()
	...
	entry({"admin", "services", "openclash", "settings"},cbi("openclash/settings"),_("Plugin Setting"), 30).leaf = true
	entry({"admin", "services", "openclash", "config-overwrite"},cbi("openclash/config-overwrite"),_("Overwrite Setting"), 40).leaf = true
	...
	entry({"admin", "services", "openclash", "log"},cbi("openclash/log"),_("Server Log"), 90).leaf = true
